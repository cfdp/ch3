...
<article<?php print $attributes; ?>>
  ...
  <header>
    <?php
      ...
      foreach($content as $key=>$value){
        switch ($key) {
          case "author_timestamp_eva_field_nodes_entity_view_6":
            $author_date_key = $key;
            break;
          case "author_timestamp_eva_field_nodes_entity_view_7":
            $counselor_date_key = $key;
            break;
          case "field_brevk_spoergsmaal":
            $question_key = $key;
            break;
          case "field_brevk_svar":
            $answer_key = $key;
            break;
        }
      }
  ...
  <div<?php print $content_attributes; ?>>
    <?php
      ...
      print render($content[$answer_key]);
