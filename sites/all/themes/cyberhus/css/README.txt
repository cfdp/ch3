...
To use these stylesheets, rename the files and cyberhus with the name of your theme.
...
cyberhus-alpha-default-narrow.css  
...
cyberhus-alpha-default-normal.css
...
cyberhus-alpha-default-wide.css
