...
<?php
  print views_embed_view('pager_brevkasse', 'block_1', $node->uid);
?>
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="node-wrapper">
    ...
    <div class="node-sidebar">
      <?php print theme('node_author_blog', array('node' => $node)); ?>
    </div>
    ...
    <div class="node-content">
      ...
      <div class="content"<?php print $content_attributes; ?>>
        <?php
          ...
          hide($content['links']);
          hide($content['field_blog_cyberlike']);
      ...
      <div class="node-interaction">
        <?php print render($content['field_blog_cyberlike']); ?>
